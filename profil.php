...
?>
    ...
    <body>
        ...
        <div align="center">
            <h2 style="color: #c1c1c1">Profil de <?php echo $userinfo['pseudo']; ?>: </h2>
            <!-- ce qu'il y a entre le <?php et ?> permet de récupérer le pseudo enrigistré dans la bdd -->

            <br /><br />
            <p style="color: #c1c1c1">Pseudo = <?php echo $userinfo['pseudo']; ?> </p>
            <p style="color: #c1c1c1">Mail = <?php echo $userinfo['mail']; ?> </p>
            <br />
            <?php
