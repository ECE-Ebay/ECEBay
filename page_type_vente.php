...
<body>  
			...
			<ul class="navbar-nav">      
				...
				<div class="dropdown">
					...
					<div class="dropdown-content">
						<a href="page_categories.php?categorie=1" >Voitures de luxe</a>
						<a href="page_categories.php?categorie=2">Voitures d'occasion</a>
	...
	<div class="row" style="margin: 40px;">
		...
		<div class="col-sm-4"> 
			<h3><a href="page_filtree.php?categorie=2">Voitures de luxe</a></h3>
			<?php
			for($i = 0; $i < 10; $i++) {
			?>
			<img src="https://placehold.it/150x80?text=IMAGE" class="img-responsive" style="width:100%" alt="Image">
