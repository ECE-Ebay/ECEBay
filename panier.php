...
<body>  
	...
	$products = $DB->query('SELECT * FROM items WHERE id IN ('.implode(',',$ids).')');	//On récupère les éléments du panier
	foreach ($products as $products):
	?>   
 		<div class="row">     
 			<div class="col-lg-4 col-md-4 col-sm-12">      
 				<img src="column1.jpg" class="img-fluid">     
 				<span><?= $products->marque; ?>€</span> 
 				<span><?= number_format($products->prix_initial,2,','," "); ?>€</span>
 			</div>     
 		</div> 
 	<?php endforeach; ?>
